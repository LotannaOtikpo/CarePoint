...
export default function Login() {
  ...
  return (
    <AuthShell
      brandName="CarePoint"
      brandSubtitle="Apex Health Technologies"
      heroTitle="Modern hospital operations."
      heroDescription="Better coordination. Better patient care. One secure workspace for appointments, clinical records, admissions, prescriptions, and billing."
      eyebrow="Welcome back"
      title="Sign in to your account"
      subtitle="Enter your credentials to access the CarePoint workspace."
