...
export default function Register() {
  ...
  const set = (k) => (e) => {
    ...
    if (k === 'phone') errors.phone = value && !/^\+?[0-9\s\-()]{7,15}$/.test(value)
    ...
    >
        <form className="auth-form register-form" onSubmit={submit}>
          ...
          <div className="field">
            ...
            <div className="input-shell">
              <Phone size={18} />
              <input id="register-phone" value={form.phone} required inputMode="tel" autoComplete="tel" placeholder="Mobile number"
                pattern="^\+?[0-9\s\-()]{7,15}$"
