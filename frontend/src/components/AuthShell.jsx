    ...
    <div className="auth-page">
      <section className="auth-brand-panel">
        <div className="auth-brand">
          ...
          <span className="brand-copy"><strong>CarePoint</strong><small>Apex Health Technologies</small></span>
        </div>

        <div className="auth-brand-content">
          <span className="auth-kicker"><Sparkles size={14} /> Modern clinical operations</span>
      ...
      <main className="auth-form-panel">
        ...
        <p className="auth-legal">Secure access to your CarePoint workspace</p>
      </main>
    </div>
  );
}